        ...
        <div className="container">
          <div className="row ipad-width2">
            <div className="col-md-8 col-sm-12 col-xs-12">
              ...
              <Pelicula titulo="oblivion (2012)" calificacion="8.1" imagenPelicula="images/uploads/mv1.jpg" director="Joss Whedon" actores="Robert Downey Jr, Chris Evans, Chris Hemsworth" fecha="1 May 2015" duracion="2hs 21 min">
